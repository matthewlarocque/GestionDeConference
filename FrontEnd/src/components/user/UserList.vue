    ...
    <el-header style="display: flex;justify-content: space-between">
      <el-form :inline="true" :model="searchObj" class="demo-form-inline">
        ...
        <el-form-item label="角色">
          <el-select v-model="searchObj.role" placeholder="角色">
...
export default {
  ...
  methods: {
    ...
    onSearch() {
      this.getUserList({currentPage:0,sizePerPage:this.pageObj.pageSize,username:this.searchObj.username,realname: this.searchObj.realname})
    },
    ...
    downLoad(){
      window.location.href='http://localhost:9999/template.xlsx'
    },
  }
}
</script>
